...
function writeStyleTable (styles) {
  ...
  const template = `
        <div id="theme" style="position:fixed; width:400px;height:200px;border:2px solid black;top: 0px; left:0px;background-color:white; overflow:auto;z-index:1000000000;">
            ${section1}
            ${section2}
        </div>
    `
